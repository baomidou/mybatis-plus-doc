---
title: Introduction
description: MyBatis-Plus is an enhancement tool for MyBatis that only enhances without changing. It simplifies development and improves efficiency with features like Lambda-style queries, pagination plugin, and code generator.
---
