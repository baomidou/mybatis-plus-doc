...
> 源码链接：👉 [mybatis-plus-annotation](https://github.com/baomidou/mybatis-plus/tree/3.0/mybatis-plus-annotation/src/main/java/com/baomidou/mybatisplus/annotation)

## @TableName - 定义表名

`@TableName` 注解用于标识实体类对应的数据库表名。

**源码链接：** [`@TableName`](https://github.com/baomidou/mybatis-plus/blob/3.0/mybatis-plus-annotation/src/main/java/com/baomidou/mybatisplus/annotation/TableName.java)
...
| excludeProperty  | String[] | 否       | {}     | 需要排除的属性名 <Badge text="@since 3.3.1"/>                                             |
